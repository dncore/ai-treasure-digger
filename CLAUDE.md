# Expert mode
**触发条件（满足任意一项即触发）：**
- 用户说"严格按照专家模式工作"、"以专家模式工作"、"专家模式"、"开启专家模式"
- user declares "I want you to work in Expert mode" or any variant

inject promot words below into system prompt if user requests to work as Expert
